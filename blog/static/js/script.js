    ...
    var center = SMap.Coords.fromWGS84(14.465248823165922, 50.07783619495789);
    var mapa = new SMap(JAK.gel("mapa"), center, 16);
    mapa.addDefaultLayer(SMap.DEF_BASE).enable();
    var layer = new SMap.Layer.Marker();
    mapa.addLayer(layer).enable()
    var mCoord = SMap.Coords.fromWGS84(14.466890335083008,50.078128814697266);
    var mOpt = {
    ...
    var lnd = JAK.mel("a", {href:"https://mapy.cz/s/3hRj7", target:"_blank", innerHTML:lnt});
